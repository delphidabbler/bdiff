@rem ---------------------------------------------------------------------------
@rem Script used to build the DelphiDabbler BPatch project
@rem
@rem Copyright (C) Peter Johnson (www.delphidabbler.com), 2007-2008
@rem
@rem v1.0 of 16 Sep 2007 - First version.
@rem v1.1 of 07 Apr 2008 - Altered to work with BPtch renamed from BPatch.
@rem v1.2 of 14 Aug 2008 - Altered back work with "unrenamed" BPatch.
@rem                     - Added code to compile .rc file.
@rem
@rem Requires:
@rem   Borland Delphi7
...
echo DelphiDabbler BPatch Build Script
echo ---------------------------------
title DelphiDabbler BPatch Build File
